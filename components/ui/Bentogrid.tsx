  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-white text-2xl font-bold mb-2">Smart Automation</h1>
        <p className="text-gray-400 text-lg">
          Streamline your content creation process with AI-powered automation
          tools.
        </p>
      </div>
    </div>
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="mb-4 px-6 mt-6">
              <div className="flex justify-between items-center mb-6 pb-2">
                <h2 className="text-white/70 text-xl">Content Performance</h2>
                <div className="flex items-center">
                  <div className="h-1 bg-black w-8 rounded-lg"></div>
                  <span className="ml-2 text-white/70 text-sm">Engagement</span>
                </div>
              </div>
              <div
                ref={chartRef}
            ...
            <div className="text-left p-6 mt-4">
              ...
              <p className="text-white/70 text-lg">
                Monitor engagement and results with our comprehensive analytics
                dashboard.
              </p>
            </div>
          </div>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                ...
                <p className="text-white/70 text-lg">
                  Seamlessly distribute your short-form content across popular
